...
| 6,366 | 198KB | 2025-10-30 | [repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org](https://github.com/MichaelRWolf/org-roam-logseq-nodes-MichaelRWolf/blob/main/pages/20230711112147-quotes.org) ← **chosen as primary source** (git clone on michael-pro; not present on wolf-air) |
...
- Copied [repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org](https://github.com/MichaelRWolf/org-roam-logseq-nodes-MichaelRWolf/blob/main/pages/20230711112147-quotes.org)
  verbatim as `quotes.txt` (6,366 lines) -- git clone on michael-pro of the same GitHub repo
...
- Moved this document from `Second_Brain/PLAN_quotes_merge.md` to `wisdom/CONSOLIDATION.md`, then renamed to `wisdom/PROJECT_quote_consolidation.md` (2026-05-11)
...
~/repos/wisdom/
  ...
  PROJECT_quote_consolidation.md  -- this file
...
- [repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org](https://github.com/MichaelRWolf/org-roam-logseq-nodes-MichaelRWolf/blob/main/pages/20230711112147-quotes.org) (git clone on michael-pro; not on wolf-air)
- `~/repos/pk/org-roam-logseq-nodes-MichaelRWolf-working-backup/pages/20230711112147-quotes.org` (local backup dir on michael-pro, not a git repo)
...
## Gaps Found on Re-audit (2026-05-11)

### 1. Logseq iCloud file -- missing obsolescence warning

File was not in the original inventory and was not warned:

```text
~/Library/Mobile Documents/iCloud~com~logseq~logseq/Documents/org-roam-logseq/pages/20230711112147-quotes.org
```
