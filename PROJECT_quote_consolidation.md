...
| 6,366 | 198KB | 2025-10-30 | `repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org` ← **chosen as primary source** (path existed on michael-pro; not present on this machine -- same content tracked at [org-roam-logseq-nodes-MichaelRWolf](https://github.com/MichaelRWolf/org-roam-logseq-nodes-MichaelRWolf/blob/main/pages/20230711112147-quotes.org)) |
...
- Copied `repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org` (on michael-pro)
  verbatim as `quotes.txt` (6,366 lines); same content at [GitHub](https://github.com/MichaelRWolf/org-roam-logseq-nodes-MichaelRWolf/blob/main/pages/20230711112147-quotes.org)
...
- `~/repos/pk/org-roam-logseq-nodes-MichaelRWolf/pages/20230711112147-quotes.org` (michael-pro only -- path does not exist on wolf-air)
- `~/repos/pk/org-roam-logseq-nodes-MichaelRWolf-working-backup/pages/20230711112147-quotes.org` (michael-pro only -- path does not exist on wolf-air)
